...
```javascript
import isPositiveNumberArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-positive-number-array@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-positive-number-array/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/assert-is-positive-number-array/actions/workflows/test.yml?query=branch:v0.2.3
