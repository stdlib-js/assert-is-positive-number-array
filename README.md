...
```javascript
import isPositiveNumberArray from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-positive-number-array@v0.2.2-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { objects, primitives } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-positive-number-array@v0.2.2-esm/index.mjs';
```
